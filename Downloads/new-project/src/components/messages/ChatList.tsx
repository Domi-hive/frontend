  ...
  return (
    <div className="w-80 border-r border-gray-100 flex flex-col">
      ...
      <div className="p-5 border-b border-gray-100">
        <h2 className="text-xl text-gray-900 mb-4" style={{ fontWeight: 600 }}>Messages</h2>
          ...
          >
            ...
            <div className="flex-1 min-w-0 text-left">
              ...
              <div className="flex items-center gap-2">
                ...
                {conversation.unread && (
                  <span className="w-5 h-5 rounded-full bg-[#1565C0] text-white text-xs flex items-center justify-center flex-shrink-0" style={{ fontWeight: 600 }}>
                    {conversation.unread}
                  </span>
                )}
              </div>
